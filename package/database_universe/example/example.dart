...
void main(List<String> args) async {
  ...
  // init database
  databaseUniverse.init(
      crypto: Crypto(key: "od8wkk8nYbgv2na8ApaL0NMGq3rcpnF5"));
  ...
  // save to disk
  databaseUniverse.disk_save(
      databaseUniverseData: databaseUniverseData, isWithClose: true);
  print("saved");
}
