...
import 'package:database_universe_dart/api/database_universe_dart_api_core.dart';
import 'package:universal_io/io.dart';

Logger logger = Logger();

Future<void> packageFullTemplateDartCli(List<String> args_raw) async {
  DatabaseUniverseDartApi packageFullTemplateDartApi = DatabaseUniverseDartApi();
  ...
  DatabaseUniverseDartBuildType server_universeDartBuildType = DatabaseUniverseDartBuildType.release;

  if (args.contains("--debug")) {
    server_universeDartBuildType = DatabaseUniverseDartBuildType.debug;
  }
