...
git init
git branch -M main
git remote add origin https://github.com/azkadev/database_universe
git remote set-url --push origin https://azkadev:{main_github_token}@github.com/azkadev/database_universe
